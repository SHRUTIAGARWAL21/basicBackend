...
const githubData = {
  ...
  following_url:
    "https://api.github.com/users/hiteshchaudhary/following{/other_user}",
  gists_url: "https://api.github.com/users/hiteshchaudhary/gists{/gist_id}",
  starred_url:
    "https://api.github.com/users/hiteshchaudhary/starred{/owner}{/repo}",
  subscriptions_url:
    "https://api.github.com/users/hiteshchaudhary/subscriptions",
  ...
  received_events_url:
    "https://api.github.com/users/hiteshchaudhary/received_events",
  type: "User",
  site_admin: false,
  name: null,
  company: null,
